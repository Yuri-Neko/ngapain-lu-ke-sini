...
async function srandomgore() {
	return new Promise((resolve, reject) => {
		let rand = Math.floor(Math.random() * 218) + 1
...
async function skonachan(query) {
	return new Promise((resolve, reject) => {
		axios.get('https://konachan.net/post?tags=' + query + '+')
			.then(({
				data
			}) => {
				const $$ = cheerio.load(data)
				...
				mat = Math.floor(Math.random() * no.length)
...
async function swallpaperhd(query) {
	return new Promise((resolve, reject) => {
...
async function spinterest(querry) {
	return new Promise((resolve, reject) => {
		 axios.get('https://id.pinterest.com/search/pins/?autologin=true&q=' + querry, {
			headers: {
			"cookie" : "_auth=1; _b=\"AVna7S1p7l1C5I9u0+nR3YzijpvXOPc6d09SyCzO+DcwpersQH36SmGiYfymBKhZcGg=\"; _pinterest_sess=; _ir=0"
...
async function swallpaper(title, page = '1') {
    return new Promise((resolve, reject) => {
...
async function swikimedia(title) {
    return new Promise((resolve, reject) => {
...
async function sigstalk2(username){
	return new Promise((resolve,reject) => {
