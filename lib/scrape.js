...
import _math from ('mathjs').default
...
async function pinterest2(querry) {
	return new Promise(async (resolve, reject) => {
...
async function wallpaperhd(query) {
	return new Promise((resolve, reject) => {
